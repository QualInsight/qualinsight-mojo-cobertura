 ...
 */
package com.qualinsight.mojo.cobertura.core.check.branch;
...
@Mojo(name = "check-it-branch-coverage", defaultPhase = LifecyclePhase.POST_INTEGRATION_TEST)
public class ITBranchCoverageCheckMojo extends AbstractBranchCheckMojo {
